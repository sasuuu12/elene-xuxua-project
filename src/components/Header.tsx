      ...
      {isOpen && (
        <div className={`md:hidden flex flex-col items-center gap-4 py-6 font-bold border-t ${theme === 'light' ? 'bg-white border-[#C3B1E1]/20' : 'bg-[#1a1a1a] border-gray-800'
          ...
          <div
            ...
            className={`flex items-center justify-center w-14 h-14 rounded-2xl mt-4 hover:scale-105 transition-all cursor-pointer relative shadow-md ${theme === 'light' ? 'bg-[#F3E8FF]' : 'bg-[#EADDF8]'
              }`}
          >
